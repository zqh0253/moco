...
class YTBDataset(Dataset):
    ...
    def __len__(self):
        ...
        if self.phase == 'train':
            return int(total_len * 0.7) // self.interval
        elif self.phase == 'eval':
            return total_len - int(total_len * 0.7) // self.interval
        else:
            return total_len
...
if __name__ == '__main__':
    transform = None
    ytbd = YTBDataset(data_path='/home/yhxu/qhzhang/workspace/ytb', phase='all', transform=transform, interval=10)
    img, steering, throttle, speed = ytbd[855550]
